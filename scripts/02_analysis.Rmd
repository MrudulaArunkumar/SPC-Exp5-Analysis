...
```{r fig.show='hold',out.width="50%"}
# m1 <- glmer(data = Phase31TCraw_Awareness,
#             FreeChoiceAccuracy ~ 1+SSCRAwareness + S2Awareness + (1|PROLIFIC_PID),
#             family = binomial,
#             glmerControl(optCtrl = list(maxfun = 2e5)))
# 
...
afex_plot(m1, x = c("SSCRAwareness"),
          error = "model",
          data_plot = T,
          error_ci = T,
...
```{r fig.show='hold', out.width="50%"}
# m2 <- glmer(data = Phase31TCraw_Awareness,
#             FreeChoiceAccuracy ~ 1+(SSCRAwareness * S2Awareness) + (1+(SSCRAwareness * S2Awareness)|PROLIFIC_PID),
#             family = binomial,
#             glmerControl(optCtrl = list(maxfun = 2e5)))
# 
...
afex_plot(m2, x = c("SSCRAwareness"),
          error = "model",
          data_plot = T,
          error_ci = T,
          #factor_levels = list(SSCRAwarness = c("Unaware","Aware")),
